...
輸入冰箱裡有的食材，從 100 道台灣家常菜中找出今天可以做的。完全靜態、零後端、零 API、零維護。
...
- 📦 **內建 100 道台灣家常菜**：蛋料理 12 / 蔬菜 19 / 肉類 20 / 海鮮 13 / 湯品 13 / 主食 16 / 早餐點心 7
...
內建 100 道為作者整理的台灣家常菜經典食譜，可自由增加。歡迎提 Pull Request 或編輯 `data/recipes.json` 加入更多。
